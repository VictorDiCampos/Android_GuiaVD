...
public class JsonFeiticos {
    ...
    public String getJson(Context c) throws IOException {
        ...
        conn.disconnect();
           String j= "[{'ID':'1', 'nome':'Abaffiato', 'descricao':'Cria um zumbido no ouvido das pessoas para evitar que elas ouçam as conversas.'},{'ID':'2','nome':'Accio', 'descricao':'Traz objetos ao dono.'}]";
            return saida;
    }
